...
//    Santos, Junaito Deaza
    ...
    public void test2201_0000002() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-2-01", "Jodie E. Richardson", "MJ-02201-LT-0000002-2020", "01/06/2020", "Closed", "Hostetter, Jeffrey", "MISSING ZIP", "Valentin, Ruth", "17602", "01/16/2020", "3:00 pm", "$1,850.00", "$1,992.75", "$100.00", "$142.75", null, "$875.00", null, null, "No", "Yes", null, null, null, "TRUE", null, null};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
    ...
    public void test2201_0000089() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-2-01", "Jodie E. Richardson", "MJ-02201-LT-0000089-2020", "11/23/2020", "Closed", "Redbud Investments LLC", "17557", "Smith, Khadijah & Smith, Donald", "17602", "12/03/2020", "11:00 am", "$1,336.43", "$1,761.70", "$1,501.45", null, "$155.25", "$1,501.45", null, null, "No", "Yes", null, null, null, "TRUE", null, "Damages: $105.00"};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
    ...
    public void test2203_0000100() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-2-03", "Mary Mongiovi Sponaugle", "MJ-02203-LT-0000100-2020", "10/07/2020", "Closed", "American Heritage Property Management, Lancaster", "17603", "Costello, Paul & Latorre, Olivia", "17603", "10/19/2020", "10:30 am", "$1,983.21", "$1,703.79", "$1,581.54", null, "$122.25", "$1,300.00", null, null, "Yes", "No", null, null, null, null, null, null};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
    ...
    public void test2204_0000100() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-2-04", "Andrew T. LeFever", "MJ-02204-LT-0000100-2020", "10/16/2020", "Closed", "Rent Period Inc", "17402", "Walz, Jenn", "17602", "10/28/2020", "10:00 am", "$250.00", "$500.75", "$0.00", null, "$250.75", "$1,095.00", null, null, "Yes", "No", "TRUE", "TRUE", null, "TRUE", null, "Kurt A. Blake, Esq. representing plaintiff Rent Period Inc; Landlord/Tenant Monetary Appeal Filed; Attorney fees: $250.00"};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
    ...
    public void test2207_0000001() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-2-07", "Tony S. Russell", "MJ-02207-LT-0000001-2020", "01/02/2020", "Closed", "Clover Property Management Inc. Agent for Owner, Lancaster", "17601", "Vasquez, Elizabeth", "17522", "01/09/2020", "10:30 am", "$1,763.00", "$1,920.13", "$1,763.00", "$122.25", "$5.00", "$695.00", null, null, "No", "Yes", null, null, null, null, null, "Server fees: $29.88"};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
    ...
    public void test2304_0000056() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-3-04", "Stuart J. Mylin", "MJ-02304-LT-0000056-2020", "09/02/2020", "Closed", "PCS CHADAGA C/O PROPERTY MANAGEMENT, INC.", "17043", "Reed, Regina", "17560", "09/15/2020", "10:30 am", "$3,378.11", "$3,997.61", "$3,810.11", "$140.75", "$5.00", "$432.00", null, null, "Yes", "No", null, null, null, null, null, "Home and Property Abandoned; Server fees: $41.75"};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
    ...
    public void test2307_0000022() {
        ...
        PdfData data = Parser.processFile(TEST_PATH + fileName);
        String[] targetData = {"MDJ 02-3-07", "Nancy G. Hamill", "MJ-02307-LT-0000022-2020", "09/15/2020", "Closed", "American Heritage Property Management", "17603", "Keith, Melissa", "17517", "09/29/2020", "9:00 am", "$2,640.00", "$1,667.00", null, null, "$167.00", "$825.00", null, null, "Yes", "No", null, null, null, null, null, "Rent reserved and due: $1,500.00"};
        Assert.assertArrayEquals(data.getRow(), targetData);
    }
